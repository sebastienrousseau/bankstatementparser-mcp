#!/usr/bin/env python3
"""Verify that the bankstatementparser-mcp package version is in lockstep everywhere.

Single source of truth: ``bankstatementparser_mcp.__version__``. This script reads
...
def _package_version() -> str:
    ...
    import bankstatementparser_mcp  # noqa: E402  (path-dependent import)

    return bankstatementparser_mcp.__version__
...
def main() -> int:
    ...
    print(f"  bankstatementparser_mcp.__version__   = {pkg}")
